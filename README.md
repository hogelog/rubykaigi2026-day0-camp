...
- 同じ時間・場所で各自が別のテーマを掘ることで、成果発表を通じて横の知識共有を得る

## 対象参加者

- STORES 社内のエンジニア(Rails での業務が中心)
- 学生若干名
- Ruby をある程度以上は書いている前提
...
| 4:30 - 5:00 | **クロージング** — 振り返り、RubyKaigi 本編で注目したいセッションの共有 |
...
- やってみた知見はぜひこのリポジトリに PR を送る、もしくは社内ブログ・Zenn 等に残す

## 当日の持ち物 / 事前準備

- Ruby 3.3 以上が動く開発環境(3.4 系推奨)
